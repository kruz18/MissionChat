...
val extendedLightMediumContrast = ExtendedColorScheme(
    brand = ColorFamily(
        brandLightMediumContrast,
        onBrandLightMediumContrast,
        brandContainerLightMediumContrast,
        onBrandContainerLightMediumContrast,
    ),
    success = ColorFamily(
    ...
    cosmicDeep = ColorFamily(
        cosmicDeepLightMediumContrast,
        onCosmicDeepLightMediumContrast,
        cosmicDeepContainerLightMediumContrast,
        onCosmicDeepContainerLightMediumContrast,
    ),
)

val extendedLightHighContrast = ExtendedColorScheme(
    brand = ColorFamily(
        brandLightHighContrast,
        onBrandLightHighContrast,
        brandContainerLightHighContrast,
        onBrandContainerLightHighContrast,
    ),
    success = ColorFamily(
    ...
    cosmicDeep = ColorFamily(
        cosmicDeepLightHighContrast,
        onCosmicDeepLightHighContrast,
        cosmicDeepContainerLightHighContrast,
        onCosmicDeepContainerLightHighContrast,
    ),
)

val extendedDarkMediumContrast = ExtendedColorScheme(
    brand = ColorFamily(
        brandDarkMediumContrast,
        onBrandDarkMediumContrast,
        brandContainerDarkMediumContrast,
        onBrandContainerDarkMediumContrast,
    ),
    success = ColorFamily(
    ...
    cosmicDeep = ColorFamily(
        cosmicDeepDarkMediumContrast,
        onCosmicDeepDarkMediumContrast,
        cosmicDeepContainerDarkMediumContrast,
        onCosmicDeepContainerDarkMediumContrast,
    ),
)

val extendedDarkHighContrast = ExtendedColorScheme(
    brand = ColorFamily(
        brandDarkHighContrast,
        onBrandDarkHighContrast,
        brandContainerDarkHighContrast,
        onBrandContainerDarkHighContrast,
    ),
    success = ColorFamily(
    ...
    cosmicDeep = ColorFamily(
        cosmicDeepDarkHighContrast,
        onCosmicDeepDarkHighContrast,
        cosmicDeepContainerDarkHighContrast,
        onCosmicDeepContainerDarkHighContrast,
    ),
)
