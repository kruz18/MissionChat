...
import ru.kyamshanov.missionChat.database.RoomConversationRepository
...
val DomainDiModule = module {
    ...
    factory<ChatWindowInteractorFactory> {
        ChatWindowInteractorFactory { ChatWindowInteractorImpl(it, get(), get()) }
    }
    factory<ConversationRepository> { RoomConversationRepository(get()) }
}